        ...
        <footer className="page-footer footer z-depth-3 halfTransparent">
            <div className="footer-copyright">
                <div className="my-container">
                    ...
                    <SignedInLinks />
                    <SignedOutLinks />
                    <a className='grey-text text-lighten-4 margin-right' href='https://github.com/ronen0072'><i className="fab fa-github project-skills-icon"/></a>
                    <a className='grey-text text-lighten-4 margin-right' href='http://linkedin.com/in/ronenfinish'><i className="fab fa-linkedin project-skills-icon"/></a>
